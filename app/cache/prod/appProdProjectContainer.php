...
class appProdProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->parameters = array(
            ...
            'assetic.ruby.bin' => '/home/comp71/.rvm/rubies/ruby-2.1.3/bin/ruby',
            'assetic.sass.bin' => '/home/comp71/.rvm/gems/ruby-2.1.3/bin/sass',
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array((dirname(dirname(dirname(__DIR__))).'/src/Ibw/JobeetBundle/Resources/config/doctrine') => 'Ibw\\JobeetBundle\\Entity'));
        $a->setGlobalBasename('mapping');
        $b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $b->addDriver($a, 'Ibw\\JobeetBundle\\Entity');
        $c = new \Doctrine\ORM\Configuration();
        $c->setEntityNamespaces(array('IbwJobeetBundle' => 'Ibw\\JobeetBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_578570a2c537886881ca1c8bcae1732892acd65bb4cadd61374de05182b91e14');
        return $instance;
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath((dirname(dirname(dirname(__DIR__))).'/src/Ibw/JobeetBundle/Resources/views'), 'IbwJobeet');
